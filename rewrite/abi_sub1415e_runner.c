...
void sub_1415E(void);
#pragma aux sub_1415E __parm __caller [] __modify __exact [__ax __si]
void sub_1415E(void) {
    IplayRegs r;

    memset(&r, 0, sizeof(r));
    iplay_sub_1415e(&r, mem, input_index, input_total, input_segment_index, input_pending);
...
int main(int argc, char **argv) {
    ...
    if (argc != 6) return 2;
    if (!streq(argv[1], "abisub1415e")) return 2;
